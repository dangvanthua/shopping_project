...
class ProductView extends Controller
{
    ...
    public function save_product(Request $request)
    {
        ...
        $rules = [
            'product_name' => 'required|regex:/^[A-Za-z0-9\s]+$/|unique:tbl_product,product_name',
    ...
    public function unactive_product($product_id) {
        ...
        DB::table('tbl_product')->where('product_id', $decoded_product_id)->update(['product_status' => 1]);
    ...
    public function active_product($product_id) {
        ...
        DB::table('tbl_product')->where('product_id', $decoded_product_id)->update(['product_status' => 0]);
...
//         $manager_product  = view('Front-end-Admin.product.edit_product')->with('edit_product',$edit_product)->with('cate_product',$cate_product)->with('brand_product');
...
public function edit_product($product_id) {
    ...
    $cate_product = DB::table('tbl_category_product')->orderby('category_id', 'desc')->get(); 
    $edit_product = DB::table('tbl_product')->where('product_id', $decoded_product_id)->get();
...
public function update_product(Request $request, $product_id) {
    ...
    // Cập nhật dữ liệu sản phẩm
    DB::table('tbl_product')->where('product_id', $decoded_product_id)->update($data);
    Session::put('message', 'Cập nhật sản phẩm thành công');
...
public function delete_product($product_id) {
    ...
    DB::table('tbl_product')->where('product_id', $decoded_product_id)->delete();
