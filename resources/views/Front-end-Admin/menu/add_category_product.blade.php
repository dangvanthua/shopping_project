    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="position-center" style="max-width: 1400px; margin: 0 auto;">
                    <form role="form" action="{{ URL::to('save-category-product') }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group">
                            <label for="category_product_name">Tên danh mục <span class="text-danger">(*)</span></label>
                            <input type="text" class="form-control" name="category_product_name" id="slug" onkeyup="ChangeToSlug();" placeholder="Danh mục">
                        ...
                        <div style="text-align: center;">
                            ...
                            <a href="{{ route('all_category_product') }}" class="btn btn-warning">Quay lại</a>
                        </div>
                    </form>
                </div>
            </div>
