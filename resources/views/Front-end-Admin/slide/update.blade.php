                ...
                <div class="col-sm-7">
                    <div class="col-sm-12">
                        <div class="form-group {{ $errors->first('sd_title') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" name="sd_title" value="" placeholder="Name ......">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group {{ $errors->first('sd_link') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" value="" name="sd_link" placeholder="link ......">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->first('sd_sort') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" value="" name="sd_sort" placeholder="0">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div style="margin-bottom:10px" >
                                <img src="" class="img-thumbnail" style="width: 100%;height:250px" alt="">
